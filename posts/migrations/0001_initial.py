# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2016-12-03 17:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('slug', models.SlugField(default=posts.models.generate_id, max_length=10, unique=True)),
                ('photo', models.FileField(upload_to=b'posts_photo')),
